 ...
 */
final class Version20200702124825 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE property_like ADD CONSTRAINT FK_B37BFF89A76ED395 FOREIGN KEY (user_id) REFERENCES users (id)');
    }
